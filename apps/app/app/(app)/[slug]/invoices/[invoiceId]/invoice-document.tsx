...
export function InvoiceDocument({ invoice }: { invoice: InvoiceDocumentData }) {
	...
	return (
		<article className="invoice-document mx-auto w-full max-w-[210mm] bg-white text-[#171717] shadow-2xl shadow-black/25 print:shadow-none">
			<section className="invoice-page min-h-[297mm] p-8 sm:p-12">
				<header className="flex items-start justify-between gap-8 border-[#171717]/15 border-b pb-8">
				...
				<div className="mt-10 overflow-hidden rounded-md border border-[#171717]/15">
					...
					{invoice.lines.map((line, index) => (
						<div
							key={line.id}
							className="grid grid-cols-[2rem_1fr_4rem_6rem_6rem] gap-3 border-[#171717]/10 border-b px-4 py-5 text-sm last:border-b-0"
						>
				...
				<div className="mt-8 ml-auto grid w-full max-w-sm grid-cols-2 gap-y-3 text-sm">
				...
				{invoice.notes ? (
					<div className="mt-10 rounded-md bg-[#f2f2f0] p-5">
			...
			<section className="invoice-page min-h-[297mm] border-[#171717]/15 border-t p-8 sm:p-12 print:border-0">
				<div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
					<div>
						<p className="font-semibold text-xs uppercase tracking-[0.18em]">
							Offline payment
						</p>
						<p className="mt-4 font-semibold text-lg">USD Business Savings</p>
						<div className="mt-5 grid grid-cols-[auto_1fr] gap-x-5 gap-y-2 text-sm">
						...
						<div className="mt-6 space-y-5">
							{TERMS.map(([title, body]) => (
								<section key={title} className="break-inside-avoid">
									...
									<p className="mt-1 text-[#555] text-sm leading-relaxed">
										{body}
									</p>
								</section>
							))}
				...
				<div className="mt-14 flex items-end justify-between border-[#171717]/15 border-t pt-8">
					<div>
